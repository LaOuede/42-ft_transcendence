...
from user.views import UserCreate, UserDelete, UserGetOne, UserGetAll, UserUpdate, UserProfile, toggle2FA, update_profile, settingsView
...
urlpatterns = [
    ...
    path("users/update/", update_profile, name="user-update"),
