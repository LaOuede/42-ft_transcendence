...
setTimeout(() => {
  ...
  const ballplight = new THREE.PointLight(0xeeeeee, 2, 50);
  ...
  const p2light1 = new THREE.PointLight(paddle2_att.light_color, 2, 50);
  ...
  const p2light2 = new THREE.PointLight(paddle2_att.light_color, 2, 50);
  ...
  const p2light3 = new THREE.PointLight(paddle2_att.light_color, 2, 50);
  ...
  const p1light1 = new THREE.PointLight(paddle1_att.light_color, 2, 50);
  ...
  const p1light2 = new THREE.PointLight(paddle1_att.light_color, 200, 50);
  ...
  const p1light3 = new THREE.PointLight(paddle1_att.light_color, 200, 50);
